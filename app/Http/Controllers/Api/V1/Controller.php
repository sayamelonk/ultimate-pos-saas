...
#[OA\Info(
    ...
    description: 'API documentation for Ultimate POS SaaS - Complete Flutter POS Integration. Includes both v1 (legacy) and v2 (new) endpoints.',
    contact: new OA\Contact(name: 'API Support', email: 'support@ultimatepos.com')
)]
#[OA\Server(url: '/api/v1', description: 'API v1 (Legacy)')]
#[OA\Server(url: '/api/v2', description: 'API v2 (New)')]
#[OA\SecurityScheme(
...
#[OA\Tag(name: 'Cash Drawer', description: 'Cash drawer management (v2)')]
#[OA\Tag(name: 'Reports', description: 'Sales and operational reports (v2)')]
#[OA\Tag(name: 'Settings', description: 'POS and outlet settings (v2)')]
#[OA\Tag(name: 'Inventory', description: 'Inventory and stock management (v2)')]
