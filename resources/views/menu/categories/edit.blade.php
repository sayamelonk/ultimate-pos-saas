<x-app-layout>
    <x-slot name="title">{{ __('products.edit_category') }} {{ $category->name }} - Ultimate POS</x-slot>

    @section('page-title', __('products.edit_category'))
    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-text">{{ __('products.edit_category') }}</h2>
        ...
        <x-card title="{{ __('products.category_information') }}">
            ...
            <x-slot name="footer">
                <div class="flex justify-end gap-3">
                    ...
                    <x-button type="submit" icon="check">{{ __('products.update_category') }}</x-button>
                </div>
            </x-slot>
        </x-card>
    </form>
