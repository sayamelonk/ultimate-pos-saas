<x-app-layout>
    <x-slot name="title">Create Purchase Order - Ultimate POS</x-slot>

    @section('page-title', 'Create PO')
    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-text">Create Purchase Order</h2>
                <p class="text-muted mt-1">Order inventory from suppliers</p>
            </div>
        </div>
    </x-slot>
