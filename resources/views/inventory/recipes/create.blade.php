<x-app-layout>
    ...
    <script>
        function recipeForm() {
            return {
                yieldQuantity: {{ old('yield_quantity', 1) }},
                ingredients: [{ inventory_item_id: '', quantity: 0, unit_id: '', cost: 0 }],
                ...
                addIngredient() {
                    this.ingredients.push({ inventory_item_id: '', quantity: 0, unit_id: '', cost: 0 });
                },
