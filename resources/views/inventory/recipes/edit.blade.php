<x-app-layout>
    <x-slot name="title">{{ __('inventory.edit_recipe') }} - Ultimate POS</x-slot>

    @section('page-title', __('inventory.edit_recipe'))
    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-text">{{ __('inventory.edit_recipe') }}</h2>
                ...
                <x-card :title="__('inventory.recipe_details')">
                    <div class="space-y-4">
                        ...
                        <x-textarea
                            ...
                            :placeholder="__('inventory.description')"
