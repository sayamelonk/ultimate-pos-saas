<x-app-layout>
    <x-slot name="title">{{ __('admin.edit_plan') }} - Ultimate POS</x-slot>

    @section('page-title', __('admin.edit_plan'))
    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-text">{{ __('admin.edit_plan') }}</h2>
                <p class="text-muted mt-1">{{ $subscriptionPlan->name }}</p>
            </div>
        </div>
    </x-slot>

    <div class="max-w-3xl" x-data="{
        features: {{ json_encode(old('features', collect($subscriptionPlan->features ?? [])->map(function($value, $key) {
            ...
            <form action="{{ route('admin.subscription-plans.update', $subscriptionPlan) }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-4 pt-6 border-t border-border">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <x-input
                            ...
                            step="1000"
                            min="0"
                            :value="$subscriptionPlan->price_monthly"
                            required
                        />
                        ...
                        <x-input
                            ...
                            step="1000"
                            min="0"
                            :value="$subscriptionPlan->price_yearly"
                            required
                        />
                    </div>
                </div>
                ...
                <div class="space-y-4 pt-6 border-t border-border">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <x-input
                            ...
                            :value="$subscriptionPlan->max_outlets"
                            required
                        />
                        ...
                        <x-input
                            ...
                            placeholder="-1"
                            hint="{{ __('admin.unlimited_hint') }}"
                            :value="$subscriptionPlan->max_users"
                            required
                        />
                        ...
                        <x-input
                            ...
                            placeholder="-1"
                            hint="{{ __('admin.unlimited_hint') }}"
                            :value="$subscriptionPlan->max_products"
                            required
                        />
                    </div>
                </div>
                ...
                <div class="space-y-4 pt-6 border-t border-border">
                    ...
                    <x-input
                        ...
                        :value="$subscriptionPlan->sort_order"
                        min="0"
                        required
                    />
                    ...
                    <x-checkbox
                        ...
                        :checked="$subscriptionPlan->is_active"
                    />
                </div>
