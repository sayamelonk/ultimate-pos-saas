...
@php
    ...
    if (str_starts_with($currentRoute, 'pos.') || str_starts_with($currentRoute, 'transactions.') || str_starts_with($currentRoute, 'customers.') || str_starts_with($currentRoute, 'qr-orders.') || str_starts_with($currentRoute, 'tables.')) {
...
<aside class="fixed inset-y-0 left-0 z-50 flex flex-col text-white transition-all duration-300 ease-in-out"
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3"
         ...
         @click="localStorage.setItem('sidebarScrollPosition', $refs.sidebarNav.scrollTop);">
        ...
        <div class="mb-2">
            ...
            <div x-show="openSections.pos || !sidebarOpen"
                ...
                @if($features['qr_order'] ?? false)
                <a href="{{ route('qr-orders.index') }}"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors
                          {{ request()->routeIs('qr-orders.*') ? 'bg-white/10 text-white' : 'text-primary-100 hover:bg-white/5 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z"/>
                    </svg>
                    <span x-show="sidebarOpen" x-transition class="whitespace-nowrap">QR Orders</span>
                </a>
                @endif

                <a href="{{ route('tables.index') }}"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors
                          {{ request()->routeIs('tables.*') ? 'bg-white/10 text-white' : 'text-primary-100 hover:bg-white/5 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M4 6h16M4 10h16M4 14h16M4 18h16"/>
                    </svg>
                    <span x-show="sidebarOpen" x-transition class="whitespace-nowrap">Kelola Meja</span>
                </a>
            </div>
        </div>
        ...
        <div class="mb-2">
            <button @click="openSections.pricing = !openSections.pricing"
                    class="w-full flex items-center justify-between px-3 py-2 rounded-lg hover:bg-white/5 transition-colors"
                    x-show="sidebarOpen">
                <span class="text-xs font-semibold text-primary-300 uppercase tracking-wider">{{ __('menu.pricing') }}</span>
                <svg class="w-4 h-4 text-primary-300 transition-transform duration-200"
                     :class="{ 'rotate-180': openSections.pricing }"
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
            </button>
            ...
            <div x-show="openSections.pricing || !sidebarOpen"
                 x-collapse
                 class="space-y-1 mt-1">
                <!-- Prices -->
        ...
        <div class="mb-2">
            <button @click="openSections.menu = !openSections.menu"
                    class="w-full flex items-center justify-between px-3 py-2 rounded-lg hover:bg-white/5 transition-colors"
                    x-show="sidebarOpen">
                <span class="text-xs font-semibold text-primary-300 uppercase tracking-wider">{{ __('menu.menu') }}</span>
                <svg class="w-4 h-4 text-primary-300 transition-transform duration-200"
                     :class="{ 'rotate-180': openSections.menu }"
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
            </button>
            ...
            <div x-show="openSections.menu || !sidebarOpen"
                 x-collapse
                 class="space-y-1 mt-1">
                <!-- Products -->
        ...
        <div class="mb-2">
            <button @click="openSections.inventory = !openSections.inventory"
                    class="w-full flex items-center justify-between px-3 py-2 rounded-lg hover:bg-white/5 transition-colors"
                    x-show="sidebarOpen">
                <span class="text-xs font-semibold text-primary-300 uppercase tracking-wider">{{ __('menu.inventory') }}</span>
                <svg class="w-4 h-4 text-primary-300 transition-transform duration-200"
                     :class="{ 'rotate-180': openSections.inventory }"
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
            </button>
            ...
            <div x-show="openSections.inventory || !sidebarOpen"
                 x-collapse
                 class="space-y-1 mt-1">
                <!-- Items -->
                ...
                <a href="{{ route('inventory.waste-logs.index') }}"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors
                          {{ request()->routeIs('inventory.waste-logs.index') || request()->routeIs('inventory.waste-logs.show') || request()->routeIs('inventory.waste-logs.create') ? 'bg-white/10 text-white' : 'text-primary-100 hover:bg-white/5 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="mb-2">
            <button @click="openSections.reports = !openSections.reports"
                    class="w-full flex items-center justify-between px-3 py-2 rounded-lg hover:bg-white/5 transition-colors"
                    x-show="sidebarOpen">
                <span class="text-xs font-semibold text-primary-300 uppercase tracking-wider">{{ __('menu.reports') }}</span>
                <svg class="w-4 h-4 text-primary-300 transition-transform duration-200"
                     :class="{ 'rotate-180': openSections.reports }"
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
            </button>
            ...
            <div x-show="openSections.reports || !sidebarOpen"
                 x-collapse
                 class="space-y-1 mt-1">
                <!-- Stock Valuation -->
        ...
        <div class="mb-2">
            <button @click="openSections.admin = !openSections.admin"
                    class="w-full flex items-center justify-between px-3 py-2 rounded-lg hover:bg-white/5 transition-colors"
                    x-show="sidebarOpen">
                <span class="text-xs font-semibold text-primary-300 uppercase tracking-wider">{{ __('menu.admin') }}</span>
                <svg class="w-4 h-4 text-primary-300 transition-transform duration-200"
                     :class="{ 'rotate-180': openSections.admin }"
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
            </button>
        ...
        <div class="mb-2">
            ...
            <div x-show="openSections.settings || !sidebarOpen"
                ...
                <a href="{{ route('subscription.index') }}"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors
                          {{ request()->routeIs('subscription.*') ? 'bg-white/10 text-white' : 'text-primary-100 hover:bg-white/5 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
                    </svg>
